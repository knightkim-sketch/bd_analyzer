...
- [TASK-0009](40-tasks/TASK-0009-motion-estimation.md) — Motion Estimation 분석 기능: SVT-AV1 정수 ME + odyssey open-loop ME 재현, 통계 오버레이 통합, ME dock, 클릭 시 블록 MV (**1차 범위 구현 완료** — 회귀 31/31. 알고리즘 정리는 Confluence)
